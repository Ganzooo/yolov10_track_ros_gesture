...
from source.dataset.sthvideo import Video_dataset as SSvVideoClsDataset
from source.dataset.sth import Video_dataset as SSinferDataset
from source.dataset.charades import Video_dataset as CharadesDataset
from source.dataset.kinetics import Video_dataset as KineticsFrameDataset
from source.dataset.Augmentation_atm import get_augmentation

from source.dataset.transforms_atm import GroupScale, GroupCenterCrop, Stack, ToTorchFormatTensor, GroupNormalize, GroupOverSample, GroupFullResSample


def build_dataset(is_train, test_mode, data_path, args):
