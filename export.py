...
from ultralytics.models.experimental import attempt_load, End2End
from ultralytics.models.yolo import ClassificationModel, Detect, DDetect, DualDetect, DualDDetect, DetectionModel, SegmentationModel
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / './data/weight/detection/yolov10b_keti_tp241120_0_90.pt', help='model.pt path(s)')
